...
- [ ] Repository created on GitHub; issues opened for Phase 1 tasks.

## Phase 1 — MVP

- [ ] `src/database/`: schema models and initial Alembic migration for `season`, `team`, `venue`, `match`, `ingestion_log`.
...
- [ ] `tests/`: unit tests for table computation and form guide; integration test for the end-to-end fixture pipeline.
